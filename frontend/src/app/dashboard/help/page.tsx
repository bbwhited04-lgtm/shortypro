...
export default function HelpPage() {
  return (
    <div className="space-y-6">
      <Section
        title="Help"
        subtitle="Quick-start guides + a ready-to-record CapCut script."
      />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card title="1) The 60‑second workflow">
          <ol className="list-decimal space-y-2 pl-5">
            <li>
              Go to <Link className="underline" href="/dashboard/videos">Videos</Link>.
            </li>
            <li>
            ...
            <li>
              Review the results in <Link className="underline" href="/dashboard/assets">Assets</Link>.
            </li>
            <li>
              Drag them into the <Link className="underline" href="/dashboard/scheduler">Scheduler</Link> and set times.
            </li>
          </ol>
        </Card>
        ...
        <Card title="2) Connect accounts (posting)">
          <p>
            Connect your social accounts from <Link className="underline" href="/dashboard/settings">Settings</Link>.
            Once connected, you can pick which pages/channels belong to which posting group.
          </p>
          <p className="mt-2">
            Tip: Start with one platform (TikTok or YouTube) to validate the workflow, then add Instagram + Facebook.
          </p>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card title="CapCut: simple editing recipe">
          <ol className="list-decimal space-y-2 pl-5">
            <li>Import your screen recording + one example short from ShortyPro.</li>
            <li>Add auto-captions, then bump font size and add a soft shadow for readability.</li>
...
Built by DEAD APP CORP.`}
      ...
      <Card title="Links">
        <div className="flex flex-wrap gap-3">
          <a className="underline" href="/index.html">ShortyPro home</a>
          <a className="underline" href="https://viraldead.pro" target="_blank" rel="noreferrer">
            ViralDead
          </a>
          <a className="underline" href="https://deadapp.pro" target="_blank" rel="noreferrer">
            DeadApp
          </a>
        </div>
      </Card>
